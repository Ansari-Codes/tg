...
class Turtle:
    ...
    def forward(self, distance):
        ...
        if self._pen:
            self._js_actions.append(
                f"ctx.beginPath(); ctx.moveTo((cw()//2) + {self._x}, ch()//2 + {self._y}); ctx.lineTo({new_x}, {new_y}); "
    ...
    def getJs(self):
        js_code = [
            ...
            "let cw = ()=>canvas.innerWidth; // Always get current width",
            "let ch = ()=>canvas.innerHeight; // get current height",
        ]
